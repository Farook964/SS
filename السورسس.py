...
@Client.on_message(
    filters.user(SUDO_USERS) & filters.command(["restart","",اعادة التشغيل"], prefixes=f"{HNDLR}")
)
...
**⌯ في سورس [🎵 سيلفا  الاك ميوزك](t.me/SB_EMPRESS)  \n\n**⌯  قناة السورس ↞ [𝐌𝐮𝐬𝐢𝐜 𝐒𝐞𝐥𝐯𝐚 🎵](t.me/SB_EMPRESS)  **\n\n⊱┉┉┉⊶𓄼•𝐌𝐮𝐬𝐢𝐜 SB•𓄹⊷┉┉┉⊰\n\n**༄⌯[مطورين اݪسورس ☊](t.me/SB_EMPRESS)⌯**\n**⌯ المطور ↞ [⊰ سحر ⊱](t.me/SB_SAHAR)**\n\n**⌯ المطور ↞ [⊰ SAHAR ⊱](t.me/SB_SAHAR)**\n\n**⌯ المطور ↞ [⊰ سحر ⊱](t.me/SB_SAHAR)**\n\n⊱┉┉┉⊶𓄼•𝐌𝐮𝐬𝐢𝐜 SB⊷┉┉┉⊰\n\n**⌯ صاحب الاك ميوزك ↞  ⊰ [{OWNER_NAME}](t.me/{OWNER}) ⊱**\n\n⊱┉┉┉⊶𓄼•𝐌𝐮𝐬𝐢𝐜 SB•𓄹⊷┉┉┉⊰\n\n                     
"""
